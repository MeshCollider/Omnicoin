Contributing to Omnicoin
========================

The Omnicoin project operates an open contributor model where anyone is welcome to contribute towards development in the form of peer review, testing and patches. This document explains the practical process and guidelines for contributing.
...
The following applies to code changes to the Omnicoin project (and related projects such as libsecp256k1), and is not to be confused with overall Omnicoin Network Protocol consensus changes.
