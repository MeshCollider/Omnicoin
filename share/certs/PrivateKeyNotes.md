...
unlocked to sign the Omnicoin-Qt.app bundle.
...
allowing somebody to distribute a Omnicoin-Qt.app or omnicoin-qt-setup.exe with a valid
...
that the omnicoin-qt.exe file inside the installer had not been tampered with.
