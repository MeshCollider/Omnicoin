...
#if defined(NDEBUG)
# error "Omnicoin cannot be compiled without assertions."
#endif
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s OMC additional fees, %d delta bytes\n",
...
void ThreadScriptCheck() {
    RenameThread("omnicoin-scriptch");
