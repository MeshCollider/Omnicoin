...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Omnicoin omnicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  omnicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded omnicoin transaction") + "\n" +
              "  omnicoin-tx [options] -create [commands]   " + _("Create hex-encoded omnicoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded omnicoin transaction
