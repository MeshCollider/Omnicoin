...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/omnicoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Omnicoin"),
     ...
     * override -datadir in the omnicoin.conf file in the default data directory
     * (to be consistent with omnicoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
