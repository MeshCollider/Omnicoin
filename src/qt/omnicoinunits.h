...
#ifndef OMNICOIN_QT_OMNICOINUNITS_H
#define OMNICOIN_QT_OMNICOINUNITS_H
...
public:
    ...
    /** Omnicoin units.
      @note Source: https://en.omnicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        OMC,
...
#endif // OMNICOIN_QT_OMNICOINUNITS_H
