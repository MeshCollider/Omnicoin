...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    COmnicoinAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    COmnicoinAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = COmnicoinAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = COmnicoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(COmnicoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(COmnicoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
